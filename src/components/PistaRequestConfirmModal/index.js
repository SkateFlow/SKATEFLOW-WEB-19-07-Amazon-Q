...
const PistaRequestConfirmModal = ({ isOpen, onClose }) => {
  return (
        ...
        >
          ...
          >
            ...
            <div style={{ 
              ...
              Sua solicitação de pista foi enviada para o sistema e está sendo analisada. 
              Você receberá uma notificação quando ela for aprovada ou se houver alguma observação.
            </div>
