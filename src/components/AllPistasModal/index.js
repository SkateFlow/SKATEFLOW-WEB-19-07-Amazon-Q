              ...
              {filteredPistas.length === 0 ? (
                ...
                <PistasGrid>
                  {filteredPistas.map((pista) => (
                    ...
                    >
                      <PistaImage 
                        src={pista.images?.[0] || pista.fotos?.[0] || 'https://via.placeholder.com/300x120/667eea/ffffff?text=🛹+Pista'}
                      ...
                      <PistaStats>
                        <StatItem>
                          <FiStar color="#667eea" />
                          <span>{pista.rating || '4.0'}</span>
                        </StatItem>
                        <StatItem>
                          <FiHeart color="#64748b" />
                          <span>{pista.likes || '0'}</span>
                        </StatItem>
                      </PistaStats>
                    </PistaCard>
                  ))}
